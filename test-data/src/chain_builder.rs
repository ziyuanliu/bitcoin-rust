...
impl ChainBuilder {
    ...
    pub fn at(&self, transaction_idx: usize) -> Transaction {
        self.transactions[transaction_idx].clone()
    }

    pub fn hash(&self, transaction_idx: usize) -> H256 {
        self.transactions[transaction_idx].hash()
    }
    pub fn size(&self, transaction_idx: usize) -> usize {
        self.transactions[transaction_idx].serialized_size()
    }
}

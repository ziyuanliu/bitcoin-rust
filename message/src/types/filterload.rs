use std::io;
use bytes::Bytes;
use ser::{Stream, Reader, Serializable, Deserializable, Error as ReaderError};
...
pub enum FilterFlags {
    ...
    All = 1,
    /// Means the outpoint is inserted into the filteronly if a data element in the scriptPubkey is matched,
    /// of the standard p2pk or p2ms forms
    PubKeyOnly = 2,
}

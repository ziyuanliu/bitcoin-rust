...
impl fmt::Display for Error {
	fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
		match *self {
			...
			// Softfork safeness
			Error::DiscourageUpgradeableNops => "Discourage Upgradeable Nops".fmt(f),
			Error::DiscourageUpgradeableWitnessProgram => "Discourage Upgradeable Witness Program".fmt(f),

...
pub struct VerificationFlags {
	...
	pub verify_discourage_upgradeable_nops: bool,
	...
	pub verify_discourage_upgradeable_witness_program: bool,
...
impl VerificationFlags {
	...
	pub fn verify_discourage_upgradeable_witness_program(mut self, value: bool) -> Self {
		self.verify_discourage_upgradeable_witness_program = value;
		self
	}
